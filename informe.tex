	...
	\section{Escalabilidad}	\label{sec:escalabilidad}
		...
		\subsection{Demo}
			...
			\subsubsection{Análisis de Datos}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.03]{images/arduino10.pdf}\caption{Hoja de Cálculos}
					\end{figure}
		...
		\subsection{Mediciones}
			...
			\begin{figure}[H]
			\centering
				\includegraphics[scale=0.03]{images/arduino3.pdf}\caption{Banco de Medición Arduino}
			\end{figure}
			...
			\begin{figure}[H]
			\centering
				\includegraphics[scale=0.03]{images/arduino4.pdf}\caption{Banco de Medición Arduino}
			\end{figure}
